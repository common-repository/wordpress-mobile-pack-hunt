...
Copyright (c) 2011 HuntMAds, James Pearce & friends, portions mTLD Top Level Domain Limited, ribot, Forum Nokia

Online support: http://huntmads.com/
...
/*
Plugin Name: Wordpress Mobile Pack + HUNT
Plugin URI: http://wordpress.org/extend/plugins/wordpress-mobile-pack-hunt/
Description: <strong>Modification of the WordPress Mobile Pack by HUNT mobile ads.</strong>
Version: 1.0.4
Author: by HUNT based on previous work by James Pearce & friends
Author URI: http://huntmads.com/
*/

define('WPMP_VERSION', '1.0.5');
...
register_activation_hook('wordpress-mobile-pack-hunt/wordpress-mobile-pack.php', 'wordpress_mobile_pack_activate');
register_deactivation_hook('wordpress-mobile-pack-hunt/wordpress-mobile-pack.php', 'wordpress_mobile_pack_deactivate');
...
function wordpress_mobile_pack_init() {
  ...
  load_plugin_textdomain('wpmp', 'wp-content/plugins/wordpress-mobile-pack-hunt', 'wordpress-mobile-pack-hunt');
}
