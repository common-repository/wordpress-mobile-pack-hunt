...
Copyright (c) 2009 HuntMAds, James Pearce & friends, portions mTLD Top Level Domain Limited, ribot, Forum Nokia
...
?>
  ...
  <body class="<?php if($wpmp_theme_group = wpmp_theme_group()) {print $wpmp_theme_group;} else {print 'base';} ?>">  <div id="wrap">
    <div id="header" style='height:auto'>
      ...
      <?php 
      /* HuntMAds won't use the ads as widget, but on header and footer.
       * this is the header call
       */
      
      echo wpmp_ads_insertion_HUNT( 'header' ) ?>
